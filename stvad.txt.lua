if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("STV is already running!", 0)
    return
end
...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "STV is waiting for the game to load"
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Infinite Yiel FE v" .. currentVersion
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the STV support server.'}
CMDs[#CMDs + 1] = {NAME = 'console', DESC = 'Loads old Roblox console'}
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = 'Opens DEX by STV'}
CMDs[#CMDs + 1] = {NAME = 'olddex / odex', DESC = 'Opens Old DEX by STV'}
CMDs[#CMDs + 1]YNAME = 'remotespy / rspy', DESC = 'Opens Simple Spy V3'}
